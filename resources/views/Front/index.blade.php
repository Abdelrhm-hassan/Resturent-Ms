                ...
                <div class="col-lg-8">
                    <div class="main-banner header-text">
                        <div class="Modern-Slider">
                          ...
                          <div class="item">
                            <div class="img-fill">
                                <img src="{{asset('Front//images/slide-01.jpg')}}" alt="">
                            </div>
                          </div>
                          <!-- // Item -->
                          <!-- Item -->
                          <div class="item">
                            <div class="img-fill">
                                <img src="{{asset('Front//images/slide-02.jpg')}}" alt="">
                            </div>
                          </div>
                          <!-- // Item -->
                          <!-- Item -->
                          <div class="item">
                            <div class="img-fill">
                                <img src="{{asset('Front//images/slide-03.jpg')}}" alt="">
                            </div>
                          </div>
                          <!-- // Item -->
                        </div>
            ...
            <div class="col-lg-12">
                <div class="owl-menu-item owl-carousel">
                   @foreach ($meal as $m)
                    ...
                    background-image: url({{asset('uploads/Meal/'.$m->img)}});
                    ">
                            <div class="price"><h6>{{$m->price}} EGP</h6></div>
                            <div class='info'>
            ...
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                                    ...
                                    <h4>Phone Numbers</h4>
                                    <span><a href="#">095270049</a><br><a href="#">01152953732</a></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <h4>Emails</h4>
                                    <span><a href="#">hello@dahaan.com</a><br><a href="#">info@dhann.com</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        <form method="POST"  id="contact" action="{{route('Front.store')}}" >
                         @csrf
                         @include('Admin.inc.error')
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="number-guests" name="gest_number" id="number-guests">
                            ...
                            <div class="heading-tabs">
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <ul>
                                          <li><a href='#tabs-1'><img src="{{asset('Front//images/tab-icon-01.png')}}" alt="">Breakfast</a></li>
                                          <li><a href='#tabs-2'><img src="{{asset('Front//images/tab-icon-02.png')}}" alt="">Lunch</a></a></li>
                                          <li><a href='#tabs-3'><img src="{{asset('Front//images/tab-icon-03.png')}}" alt="">Dinner</a></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="left-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('Front//images/tab-item-01.png')}}" alt="">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('Front//images/tab-item-02.png')}}" alt="">
                                                            <h4>Orange Juice</h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur koit adipiscing elit, sed do.</p>
                                                            <div class="price">
                                                                <h6>$8.50</h6>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('Front//images/tab-item-03.png')}}" alt="">
                                                            <h4>Fruit Salad</h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur koit adipiscing elit, sed do.</p>
                                                            <div class="price">
                                                                <h6>$9.90</h6>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="right-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('Front//images/tab-item-04.png')}}" alt="">
                                                            <h4>Eggs Omelette</h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur koit adipiscing elit, sed do.</p>
                                                            <div class="price">
                                                                <h6>$6.50</h6>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('Front//images/tab-item-05.png')}}" alt="">
                                                            <h4>Dollma Pire</h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur koit adipiscing elit, sed do.</p>
                                                            <div class="price">
                                                                <h6>$5.00</h6>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="{{asset('Front//images/tab-item-06.png')}}" alt="">
