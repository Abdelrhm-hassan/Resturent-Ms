...
<div class="d-flex justify-content-between ">
    ...
    <h3 class="tm-site-title" > Meals / Create / New Meal </h3>
      ...
      <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
        <div class="row ">
          <div class=" card-header card-header-border-bottom  col-12">
            <h2 class=" tm-block-title d-inline-block">Add Meal</h2>
          </div>
        </div>
        <div class="row tm-edit-product-row">
          ...
          <div class=" card-body col-xl-6 col-lg-6 col-md-12">
            ...
            <form action="{{route('Admin.Meals.store')}}" enctype="multipart/form-data"method="post" class="tm-edit-product-form">
             @csrf
              ...
              <div class="form-group mb-3">
                ...
                <textarea id="name" name="desc" type="text" class="form-control validate" required ></textarea>
              </div>
