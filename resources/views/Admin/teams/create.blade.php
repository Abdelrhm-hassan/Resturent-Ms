...
<div class="d-flex justify-content-between ">
    ...
    <h3 class="tm-site-title" > Teams / Create / New Member </h3>
      ...
      <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
        ...
        <div class="row tm-edit-product-row">
          ...
          <div class=" card-body col-xl-6 col-lg-6 col-md-12">
            ...
            <form action="{{route('Admin.Teams.store')}}" enctype="multipart/form-data"method="post" class="tm-edit-product-form">
             @csrf
              ...
              <div class="form-group mb-3">
                ...
                <input id="name" name="code" type="text" placeholder="ex C1900" class="form-control validate" required />
              </div>
              <div class="form-group mb-3">
